...
class AESApp:
    ...
    def create_encrypt_tab(self):
        ...
        self.generate_key_button_encrypt = tk.Button(frame, text="Generate Key", command=self.generate_key)
        self.generate_key_button_encrypt.grid(row=0, column=2, padx=5, pady=5)
        
        tk.Label(frame, text="Text to Encrypt:").grid(row=1, column=0, padx=5, pady=5)
        self.text_entry_encrypt = tk.Entry(frame, width=64)
        self.text_entry_encrypt.grid(row=1, column=1, padx=5, pady=5)
        
        self.file_button_encrypt = tk.Button(frame, text="Choose File", command=self.choose_file_encrypt)
        self.file_button_encrypt.grid(row=2, column=0, columnspan=2, padx=5, pady=5)
        
        self.encrypt_button = tk.Button(frame, text="Encrypt", command=self.encrypt_data)
    ...
    def create_decrypt_tab(self):
        ...
        tk.Label(frame, text="Text to Decrypt:").grid(row=1, column=0, padx=5, pady=5)
        self.text_entry_decrypt = tk.Entry(frame, width=64)
        self.text_entry_decrypt.grid(row=1, column=1, padx=5, pady=5)
        
        self.file_button_decrypt = tk.Button(frame, text="Choose File", command=self.choose_file_decrypt)
        self.file_button_decrypt.grid(row=2, column=0, columnspan=2, padx=5, pady=5)
        
        self.decrypt_button = tk.Button(frame, text="Decrypt", command=self.decrypt_data)
    ...
    def decrypt_data(self):
        ...
        text = self.text_entry_decrypt.get()
